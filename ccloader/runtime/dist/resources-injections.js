...
impactModuleHooks.add('impact.base.image', () => {
    ig.Image.inject({
        loadInternal(path) {
            ...
            resources.loadImage(path, { callerThisValue: this }).then((img) => {
                this.data = img;
                this.onload();
            }, (err) => {
...
function applyImpactFileForwarding(path) {
...
//# sourceMappingURL=resources-injections.js.map