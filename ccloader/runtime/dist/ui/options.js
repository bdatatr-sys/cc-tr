...
const LOG_LEVEL_OPTION_IDS = {
    LOG: 'logLevel-log',
    WARN: 'logLevel-warn',
    ERROR: 'logLevel-error',
};
const MOD_ENABLED_OPTION_ID_PREFIX = 'modEnabled-';
const INSTALLED_MODS = Array.from(modloader.installedMods.values())
...
resources.jsonPatches.add('data/lang/sc/gui.en_US.json', (data) => {
...
ig.module('ccloader-runtime.ui.options')
    .requires('impact.base.font', 'game.feature.font.font-system', 'game.feature.model.options-model', 'game.feature.menu.gui.options.options-list', 'game.feature.menu.gui.options.options-types')
    .defines(() => {
    ...
    const MODS_TAB_ID = 'mods';
    sc.fontsystem.font.pushIconSet(new ig.Font('mod://ccloader-runtime/media/icons.png', 16, ig.MultiFont.ICON_START), { [MODS_TAB_ID]: 0 });
    ...
    sc.OptionModel.inject({
        ...
        onStorageGlobalSave(globalsData, ...args) {
            ...
            for (let level of consoleM.LOG_LEVEL_NAMES) {
                logLevels[level] = options[LOG_LEVEL_OPTION_IDS[level]];
            }
    ...
    sc.OptionRow.inject({
        ...
        init(...args) {
            ...
            if (this.option.mod != null) {
                ...
                for (let iconScale = currentScale; iconScale > 0; iconScale--) {
                    ...
                    if (currentScale % iconScale !== 0)
                        continue;
                    let iconPath = (_a = mod.manifest.icons) === null || _a === void 0 ? void 0 : _a[iconSize];
                    if (iconPath == null)
                        continue;
                ...
                this.modVersionGui.setPos(this.lineGui.hook.size.x - this.modVersionGui.hook.size.x + 1, this.lineGui.hook.pos.y + 1);
        ...
        updateDrawables(renderer) {
            ...
            if (this.option.mod != null) {
                ...
                let scaleX = 1;
                let scaleY = 1;
                if ((_a = this.modIconGfx) === null || _a === void 0 ? void 0 : _a.loaded) {
