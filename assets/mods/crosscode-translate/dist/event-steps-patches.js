"use strict";
ig.module('crosscode-translate.fixes.event-steps.shakeit')
    ...
    ig.EVENT_STEP.DO_THE_SHAKE.inject({
        start() {
            ...
            let parts = ['first', 'second', 'third'].map((s) => randomElement(ig.lang.get(`sc.gui.shakeit.${s}`)));
...
//# sourceMappingURL=event-steps-patches.js.map