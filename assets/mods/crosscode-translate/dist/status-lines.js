...
ig.module('crosscode-translate.fixes.status-line-graphics.enemy-list')
    ...
    sc.EnemyBaseParamLine.inject({
        patchedGfx: new ig.Image('media/gui/menu.uk_UA.png'),
...
ig.module('crosscode-translate.fixes.status-line-graphics.simple-status-display')
...
ig.module('crosscode-translate.fixes.status-line-graphics.status-menu')
...
//# sourceMappingURL=status-lines.js.map