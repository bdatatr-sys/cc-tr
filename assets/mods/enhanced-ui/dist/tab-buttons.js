...
// sc.ArenaRoundList
// sc.ArenaCupList
function autoAdjustTabWidths(container, newIndex, tabs) {
    var _a, _b;
    ...
    if (container.UI2_INCREASE_TAB_BUTTON_WIDTH != null) {
        ...
        try {
            ...
            width = newBtn.textChild.hook.size.x + ((_a = container.UI2_TAB_BTN_AUTO_WIDTH_PADDING) !== null && _a !== void 0 ? _a : 16);
        }
        finally {
            newBtn.pressed = prevPressed;
            newBtn.textChild.setText(prevText);
        }
        let newBtnMinWidth = (_b = container.UI2_TAB_BTN_AUTO_WIDTH_MIN) !== null && _b !== void 0 ? _b : newBtn._largeWidth;
...
//# sourceMappingURL=tab-buttons.js.map